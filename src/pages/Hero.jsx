    ...
    <section className="relative overflow-hidden bg-ink text-white">
      ...
      <div className="container-x relative z-10 grid gap-12 py-16 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        ...
        <motion.div variants={stagger} initial="hidden" animate="show">
          ...
          >
            Most merchants fix their ads and forget their checkout. We fix the part
            after the click — the cart, the slow checkout, the recovery flow — and
            engineer funnels that turn browsers into buyers, for Lazada, Shopee, and
            your own store.
          </motion.p>
